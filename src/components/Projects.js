...
import Slime from '../assets/images/slime-project4.png';
...
function Banner() {
    return(
        <div className="projects-section debug">
            ...
            <div className="debug">
                <div className="project-cont margin-btm-project">
                ...
                <div className="project-cont-reverse margin-btm-project">
                <div className="text-white">
                        <h1 className="project-title causten-bold cursor-default">
                        ...
                        <p className="project-para-reverse causten-light cursor-default text-offwhite">A modern e-commerce store with a whimsical slime theme for a younger audience.
                        </p>
                        <div>
                        ...
                        <div className="project-button-row-reverse">
                            <div>
                                <a class="icon2" href="https://github.com/perezryan26/slimestorewebapp">
                                    <FontAwesomeIcon icon={faGithub} class="project-icon text-offwhite" />
                                </a>
                            </div>
                            <div className="ps-4">
                                <a href="https://ryanperezportfolio.netlify.app/">
                                    <FontAwesomeIcon icon={faCircleArrowRight} class="project-icon text-offwhite" />
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="project-img-cont">
                        <img className="project-img" src={Slime} alt="Slime Emporium"/>
                        <div className="project-img-after"></div>
                    </div>
                </div>
                ...
                <div className="project-img-cont">
                    ...
                    <div className="text-white">
                        ...
                        <p className="project-para causten-light cursor-default text-offwhite">
                            An intuitive calculator app, taking inspiration from the iPhone's calculator application.
                        </p>
                        <div>
                            <div className="project-badge-row">
